...
contract FlightSuretyApp {
    ...
    FlightSuretyData flight_surety;
    ...
    */
    ...
    {
        require(flight_surety.isAirlinePaid(msg.sender), "Caller has not paid");
        _;
    }
    ...
    {
        require(flight_surety.isAirlinePaid(airline), "Caller has not paid");
        _;
    }

      modifier requireNotAirlineAuthorized(address airline)
    {
        require(!flight_surety.isAirlineAuthorized(airline), "Airline has been authorized");
        _;
    }                 
    ...
    */
                                ...
                                public 
    {
        ...
        flight_surety = FlightSuretyData(dataContract);
    }
